...
class MyCustomComparator implements Comparator<TotalReturnsDto>{

  @Override
  public int compare(TotalReturnsDto bean1, TotalReturnsDto bean2) {
    // TODO Auto-generated method stub
    return Double.compare(bean1.getClosingPrice(), bean2.getClosingPrice());
  }
...
public class PortfolioManagerApplication {
  ...
  public static List<String> mainReadFile(String[] args) throws IOException, URISyntaxException {
    ...
    PortfolioTrade[] list = objectMapper.readValue(file, PortfolioTrade[].class);
    // System.out.println("here is list "+list.length);
    List<String> symbolExtraction=new ArrayList<>();
    for(PortfolioTrade b:list){
      symbolExtraction.add(b.getSymbol());
    }
    // System.out.println("here is "+symbolExtraction);
  ...
  public static List<String> debugOutputs() {
     ...
     String resultOfResolveFilePathArgs0 = "/home/crio-user/workspace/vuggamvenu8-ME_QMONEY_V2/qmoney/bin/main/trades.json";
  ...
  public static List<String> mainReadQuotes(String[] args) throws IOException, URISyntaxException {
    ...
    LocalDate localEndDate=LocalDate.parse(args[1]);
    List<TotalReturnsDto> totalReturnsDto=new ArrayList<>();
    for(PortfolioTrade b:list){
      List<Candle> listOfTiingo = fetchCandles(b,localEndDate,token);  
      TiingoCandle candle = (TiingoCandle) listOfTiingo.get(listOfTiingo.size()-1);
      TotalReturnsDto dto = new TotalReturnsDto(b.getSymbol(), candle.getClose());
      totalReturnsDto.add(dto);
    }

    Collections.sort(totalReturnsDto, new MyCustomComparator());
    List<String> sym=new ArrayList<>();
    for(TotalReturnsDto b:totalReturnsDto){
      sym.add(b.getSymbol());
    }
    return sym;
  }
  ...
  public static List<PortfolioTrade> readTradesFromJson(String filename) throws IOException, URISyntaxException {
    ...
    ObjectMapper objectMapper=getObjectMapper();
    List<PortfolioTrade> list = objectMapper.readValue(file, new TypeReference<List<PortfolioTrade>>() {}); 
    return list;
  }
  ...
  public static String prepareUrl(PortfolioTrade trade, LocalDate endDate, String token) {
    //forming url based on given details
    // https://api.tiingo.com/tiingo/daily/aapl/prices?startDate=2019-01-02&endDate=2019-01-04&token=29b2c1a67c469b10c66a09b1344fb74fd42178ea
  ...
  public static List<Candle> fetchCandles(PortfolioTrade trade, LocalDate endDate, String token) {
    ...
    RestTemplate rest=new RestTemplate();
    Candle[] data = rest.getForObject(url, TiingoCandle[].class);
    return List.of(data);
  }
